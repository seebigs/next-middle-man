...
export default function nextMiddleMan (middlewares) {
    ...
    async function handler (request, event) {
        ...
        /**
         * @type {import('./types').MiddlewareResponse}
         */
        let response;

        /**
         * For a "forwarding" middleare chain that ends with NextResponse.next()
        ...
        /**
         * For a "terminating" middleare chain that ends with NextResponse.json/redirect()
